...
if(isset($_POST['add_group'])){
	...
	$query = "INSERT INTO groups (group_name, created_date) VALUES ('$group_name', '$date')";
	if (mysqli_query($conn, $query)) {
		sleep(5);
		echo "
			<div class='alert alert-success alert-dismissible text-white' role='alert' id='success_element'>
			<span class='text-sm'>Group added succesfully!!</span>
		...
		echo "
			...
			<span class='text-sm'>Group creation unsuccessful, Try Again!</span>
			</div>
		";
	}
}
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white  active bg-gradient-primary" href="library_groups">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder mb-0">Groups</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      <div class="row">
			...
			<div class="card-header mx-4 p-3 text-center">
				...
				<form class="text-start" method="POST">
					  ...
					  <div class="text-center">
						<button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2" name="add_group">Add</button>
					  </div>
					</form>
            </div>
          </div>
        ...
        <div class="col-md-7 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Manage Groups</h6>
            </div>
            <div class="card-body pt-4 p-3">
              <ul class="list-group">
				<?php
						...
						echo "
								<li class='list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg'>
								  <div class='d-flex flex-column'>
									<h6 class='mb-3 text-sm'>".$row['group_name']."</h6>
								  </div>
								  <div class='ms-auto text-end'>
									<a class='btn btn-link text-danger text-gradient px-3 mb-0' href='../includes/function?group_id=".$row['id']."'><i class='material-icons text-sm me-2'>delete</i>Delete</a>
								  </div>
								</li>
							";
						}
